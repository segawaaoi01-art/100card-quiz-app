      ...
      <div className="w-full max-w-2xl flex flex-col items-center">
        ...
        {gameState === "MUSIC_DETAIL" && (
          <div className="flex flex-col items-center w-full bg-white/80 p-6 md:p-10 rounded-3xl shadow-lg border border-white animate-fade-in relative">
            ...
            <div className="w-full flex flex-col gap-8 max-h-[50vh] overflow-y-auto mb-8 bg-white/60 px-[2.3rem] py-8 rounded-xl text-[#1c305c] leading-relaxed whitespace-pre-wrap text-left shadow-[0_4px_15px_rgba(0,0,0,0.05)] border border-white/20 tracking-[-0.02em]">
        ...
        {(gameState === "CHOICE" || gameState === "RESULT") && currentPoem && (
          <div className="flex flex-col items-center w-full bg-white/60 p-6 md:p-12 rounded-3xl backdrop-blur-sm animate-fade-in relative shadow-sm border border-white">
            ...
            <div className="flex flex-col items-center w-full text-[#1c305c] mb-2">
              ...
              <div className="w-full flex flex-col items-center gap-1.5 px-4 overflow-hidden max-h-[120px] justify-center">
                <p
                  className="question-text font-bold font-serif text-center max-w-full whitespace-pre-wrap block"
                >
                  {formatPoemText(currentPoem.kamiNoKu)}
                </p>
                {gameState === "RESULT" && (
                  <p
                    className="question-text font-bold font-serif text-[#89c3eb] animate-fade-in text-center max-w-full whitespace-pre-wrap block"
                  >
